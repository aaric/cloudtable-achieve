...
public class LemonIndexTestMain {
  private final static Log LOG = LogFactory.getLog(LemonIndexTestMain.class.getName());
  ...
  public static void main(String[] args) {
    ...
    // test hbase
    LemonIndexSample oneSample;
    try {
      oneSample = new LemonIndexSample(conf);
      oneSample.test();
    } catch (Exception e) {
